    ...
    <div class="tour_page_head" style="background-image: url(https://www.xtrafondos.com/descargar.php?id=4621&resolucion=2560x1440)">
      <div class="write_comment" style="margin-top: 15%; margin-bottom: 5%; margin-left: 5%; width: 90%;">
            ...
            <div class="center">
                ...
                <asp:TextBox ID="create_propuesta_empresa" runat="server" type="text" style=" width:100%" class="input" placeholder="Empresa"></asp:TextBox>
                <asp:RequiredFieldValidator ID="empresa_propuesta_requerido" ControlToValidate="create_propuesta_empresa" validationgroup="GrupoCrearPropuesta" ForeColor="Red" style="float:left; margin-left: 10px; margin-top: 5px; " runat="server" ErrorMessage="*Titulo requerido"></asp:RequiredFieldValidator>
                <asp:RegularExpressionValidator ID="empresa_propuesta_formato" ControlToValidate="create_propuesta_empresa" validationgroup="GrupoCrearPropuesta" style="float:left; margin-left: 10px; margin-top: 5px; " runat="server" Display="Dynamic" ForeColor="Red" ValidationExpression="^[-.:,0-9A-Za-zÀ-ÿ ]+$" ErrorMessage="*Formato de titulo incorrecto"> </asp:RegularExpressionValidator>
