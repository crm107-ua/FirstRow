...
<asp:Content ID="Content1" ContentPlaceHolderID="Main" runat="server">
    <div class="tour_page_head" style="background-image: url(https://img5.goodfon.com/wallpaper/nbig/5/d9/italiia-gorod-poberezhe-riomadzhore-doma-zdaniia-vecher-more.jpg)">
      <div class="write_comment" style="margin-top: 15%; margin-bottom: 5%; margin-left: 5%; width: 90%;">
            ...
            <div class="center">
                <asp:TextBox id="create_titulo_blog" runat="server" type="text" style="margin-top: 3%; width:100%" class="input" placeholder="Titulo" value="Ejemplo Titulo Blog"></asp:TextBox>
                ...
                <asp:TextBox id="create_descripcion_blog" placeholder="Descripción" style="margin-top: 3%; width:100%; height: 150px; line-height: 250%;" class="input" TextMode="multiline" runat="server" text="Ejemplo Descripcion Blog" />
                ...
                <asp:TextBox id="create_text_1_blog" placeholder="Texto 1" style="margin-top: 3%; width:100%; height: 150px; line-height: 250%;" class="input" TextMode="multiline" runat="server" text="Ejemplo Texto 1 Blog" />
                ...
                <asp:TextBox id="create_text_2_blog" placeholder="Texto 2" style="margin-top: 3%; width:100%; height: 150px; line-height: 250%;" class="input" TextMode="multiline" runat="server" text="Ejemplo Texto 2 Blog" />
                ...
                <asp:TextBox id="create_text_3_blog" placeholder="Texto 3" style="margin-top: 3%; width:100%; height: 150px; line-height: 250%;" class="input" TextMode="multiline" runat="server" text="Ejemplo Texto 3 Blog" />
                ...
                <asp:TextBox id="create_citacion_blog" runat="server" type="text" style="margin-top: 3%; width:100%" class="input" placeholder="Menciona una cita" value="Ejemplo Cita Blog"></asp:TextBox>
